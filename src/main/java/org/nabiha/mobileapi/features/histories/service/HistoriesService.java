...
public class HistoriesService implements IHistoriesService{
    ...
    @Override
    public HistoriesResponseDTO createHistory(HistoriesRequestDTO historiesRequestDTO) throws ServiceBusinessException {
        ...
        try{
            ...
            historiesResponseDTO = mapper.convertToDTO(res);
